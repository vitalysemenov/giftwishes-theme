...
<div class="login-box">
	...
	<div class="login-box-body">
		...
		{!! Form::close() !!}
		<a href="/social/vkontakte/connect">vk{{ trans('orchestra/foundation::title.vk') }}</a>
		<a href="/social/yandex/connect">ya{{ trans('orchestra/foundation::title.ya') }}</a>
		<a href="/social/facebook/connect">fb{{ trans('orchestra/foundation::title.fb') }}</a>
